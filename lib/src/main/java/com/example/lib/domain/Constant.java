...
public class Constant {
    ...
    public static final String CLOUD_NODE_SERVICE_API = "/app/api/pollution";
    ...
    public static final String CFG_APK_URL_DEV = "http://36.7.84.128:8000/development/wyCloudApp.apk";//测试环境APK下载连接
    public static final String CFG_APK_URL_PRODUCT = "http://36.7.84.128:8000/wyCloudApp.apk";//生产环境APK下载连接
...
//    public static final String NODE_SERVICE_PORT = "9699";
    ...
    //临时测试环境
    /*public static final String NODE_SERVICE_IP = "192.168.200.63";
    public static final String NODE_SERVICE_PORT = "3031";*/
