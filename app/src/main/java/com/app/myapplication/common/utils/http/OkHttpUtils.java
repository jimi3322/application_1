...
public class OkHttpUtils {
     ...
     * test
     */
    public void get(Context context, final String url,  final IResponseHandler responseHandler){
    ...
    private class MyCallback implements Callback {
        ...
        public void onResponse(Call call, final Response response) throws IOException {
            if(response.isSuccessful()) {
                ...
                Log.i("zyh", "onResponse: response = " + responseBody);
                mHandler.post(new Runnable() {
                    @Override
                    public void run() {
                        try {
                            ...
                            Log.i("test", "run: e = "  + e.toString());
                           ((GsonResponseHandler)mResponseHandler).onSuccess(response.code(), null);
                        }
