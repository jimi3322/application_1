...
import com.app.myapplication.http.request.ProgressRequestBody;
import com.app.myapplication.http.response.GsonResponseHandler;
import com.app.myapplication.http.response.IResponseHandler;
    ...
    private class MyCallback implements Callback {
        ...
        public void onResponse(Call call, final Response response) throws IOException {
            if(response.isSuccessful()) {
                ...
                Log.i("zyh", "onResponse: = " + responseBody);
                mHandler.post(new Runnable() {
                    @Override
                    public void run() {
