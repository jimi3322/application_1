...
public class WaterConstants {
    ...
    //获取报警解决详情
    public static final String GET_ALARM_DISPOSAL_INFO = "GetAlarmDisposalInfo";
    ...
    public static final String NONE_POLLUTED_TEXT = "暂无数据";
    public static final String NONE_POLLUTED = "#999999";
