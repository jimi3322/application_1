...
public class DBHelper extends SQLiteOpenHelper {
    ...
    // 数据库文件目标存放路径为系统默认位置，com.cloud.wayeal 是你的包名
    private static String DB_PATH = "/data/data/com.wayeal.app/databases/";
    /*
     * //如果你想把数据库文件存放在SD卡的话 private static String DB_PATH =
     * android.os.Environment.getExternalStorageDirectory().getAbsolutePath() +
     * "/arthurcn/drivertest/packfiles/";
     */
    private static String DB_NAME = "wayeal_cities.db";
    private static String ASSETS_NAME = "wayeal_cities.db";

    private static String CREATE_DB_FAIL = "Fail to Create Database";
    ...
    public void createDataBase() throws IOException {
        ...
        if (dbExist) {
            ...
            try {
                ...
                throw new Error(CREATE_DB_FAIL);
            }
        }
    }
